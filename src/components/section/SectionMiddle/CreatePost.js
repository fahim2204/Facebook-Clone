                ...
                <div className="col-12">
                    <div className="row my-3 mx-2 d-flex justify-content-center align-items-center">
                        ...
                        <div className="col-4 d-flex justify-content-center align-items-center">
                            ...
                            <span className="text-muted fw-semibold ms-2">Feeling/Acivity</span>
                        </div>
                    </div>
                </div>
            </div>
