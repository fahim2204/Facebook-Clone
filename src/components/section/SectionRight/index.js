            ...
            <div className="d-flex flex-column justify-content-start mt-3 ms-4">
                <div className="d-flex align-items-center mb-1 justify-content-between">
                    ...
                    <span>
                        ...
                        <span className="mx-2"><svg xmlns="http://www.w3.org/2000/svg" fill="grey" height="16" width="16" viewBox="0 0 20 20"><g fill-rule="evenodd" transform="translate(-446 -350)"><path d="M458 360a2 2 0 1 1-4 0 2 2 0 0 1 4 0m6 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0m-12 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0"></path></g></svg></span>
                    </span>
                </div>
